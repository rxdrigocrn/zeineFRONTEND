...
const variantStyles = {
    base: 'flex w-full items-center justify-between rounded-lg border-2 px-5 py-2.5 font-semibold transition-colors focus:outline-none hover:scale-[0.95] transition-transform duration-200 cursor-pointer',
