...
const SelectInput: React.FC<SelectInputProps> = ({ label, items, onSelect, leftIcon, value }) => {
  ...
  const containerClasses = clsx(
    'flex items-center justify-between cursor-pointer w-full border-b transition-colors px-3 py-2 relative z-10',
    {
      'border-gray-300 text-orange-base': isActive,
      'border-gray-100 text-gray-200': !isActive,
      'text-orange-base': isActive || isFilled,
      'text-gray-200': !isActive && !isFilled,
    }
  );
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {/* Trigger */}
      <button type="button" onClick={() => setIsOpen(!isOpen)} className={containerClasses}>
              ...
              return (
                <motion.li
                  ...
                  className={clsx(
                    ...
                    isSelected ? 'text-orange-base font-medium' : 'text-gray-600 hover:text-orange-500'
                  )}
                >
                  {item.label}
